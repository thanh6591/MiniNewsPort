...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    vectorEngine: process.env.VECTOR_ENGINE || "pgvector",
    vectorDualWrite: process.env.VECTOR_DUAL_WRITE || "1",
    vectorShadowRead: process.env.VECTOR_SHADOW_READ || "0",
    vectorCutoverMinOverlap: process.env.VECTOR_CUTOVER_MIN_OVERLAP || "0.70",
    vectorCutoverMaxP95Ms: process.env.VECTOR_CUTOVER_MAX_P95_MS || "900",
    vectorCutoverMaxErrorRate: process.env.VECTOR_CUTOVER_MAX_ERROR_RATE || "0.01",
